...
{
    public class StackNetwork : NetModelsLibrary.Network
    {
        List<string> stack = new List<string>();

        public StackNetwork(NetworkStream stream, CancellationToken token) : base(stream, token)
        {
            Task.Factory.StartNew(Process, token);
        }
